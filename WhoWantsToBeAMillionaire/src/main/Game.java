...
public class Game {
    ...
    public void start() throws InvalidInputException {
        ...
        while (level <= 5) {
            ...
            HelpAnswer[] activeHelpAnswers = null;
            ...
            while (!answered) {
                ...
                System.out.print("👉 Alege răspunsul (a/b/c/d sau F/A/P): ");
                ...
                if (input.length() == 1 && input.charAt(0) >= 'a' && input.charAt(0) <= 'd') {
                    try {
                        ...
                        System.out.println("⚠️ Eroare internă la procesarea răspunsului.");
                    }
                    continue;
                }
                ...
                // 3. Invalid
                System.out.println("⚠️ Răspuns invalid. Introdu a, b, c, d sau F/A/P.");
            }
        }
    ...
    public static void initQuestions() {
        ...
        nivel1.add(new Question("Prefixul „eco” vine de la un cuvânt grecesc care înseamnă:",
                new Answer[]{
        ...
        nivel1.add(new Question("Câte continente există pe Pământ?",
                new Answer[]{
        ...
        nivel2.add(new Question("Care este cel mai mare ocean al lumii?",
                new Answer[]{
        ...
        nivel2.add(new Question("Ce organ din corp produce insulina?",
                new Answer[]{
        ...
        nivel3.add(new Question("În ce an a avut loc Revoluția Franceză?",
                new Answer[]{
        ...
        nivel3.add(new Question("Cine a pictat Mona Lisa?",
                new Answer[]{
        ...
        nivel4.add(new Question("Ce element chimic are simbolul „O”?",
                new Answer[]{
        ...
        nivel4.add(new Question("Care este capitala Canadei?",
                new Answer[]{
        ...
        nivel5.add(new Question("Cine a scris piesa de teatru „Hamlet”?",
                new Answer[]{
        ...
        nivel5.add(new Question("Ce planetă este cunoscută ca „Planeta Roșie”?",
                new Answer[]{
